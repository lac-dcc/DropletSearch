...
#endif
extern "C" __global__ void __launch_bounds__(256) default_function_kernel(float* __restrict__ A, float* __restrict__ compute) {
  ...
  for (int k_outer = 0; k_outer < 128; ++k_outer) {
    ...
    A_shared[(((int)threadIdx.x) + 256)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 32768)];
    A_shared[(((int)threadIdx.x) + 512)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 65536)];
    A_shared[(((int)threadIdx.x) + 768)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 98304)];
    A_shared[(((int)threadIdx.x) + 1024)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 131072)];
    A_shared[(((int)threadIdx.x) + 1280)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 163840)];
    A_shared[(((int)threadIdx.x) + 1536)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 196608)];
    A_shared[(((int)threadIdx.x) + 1792)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 229376)];
    A_shared[(((int)threadIdx.x) + 2048)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 262144)];
    A_shared[(((int)threadIdx.x) + 2304)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 294912)];
    A_shared[(((int)threadIdx.x) + 2560)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 327680)];
    A_shared[(((int)threadIdx.x) + 2816)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 360448)];
    A_shared[(((int)threadIdx.x) + 3072)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 393216)];
    A_shared[(((int)threadIdx.x) + 3328)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 425984)];
    A_shared[(((int)threadIdx.x) + 3584)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 458752)];
    A_shared[(((int)threadIdx.x) + 3840)] = A[(((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 3) * 1024)) + (k_outer * 8)) + (((int)threadIdx.x) & 7)) + 491520)];
    __syncthreads();
    for (int k_inner_outer = 0; k_inner_outer < 8; ++k_inner_outer) {
      A_shared_local[0] = A_shared[((((int)threadIdx.x) * 8) + k_inner_outer)];
      A_shared_local[1] = A_shared[(((((int)threadIdx.x) * 8) + k_inner_outer) + 2048)];
  ...
  compute[(((((int)blockIdx.x) * 512) + ((int)threadIdx.x)) + 256)] = compute_local[1];
}
